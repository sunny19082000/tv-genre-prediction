# tv-genre-prediction
Classic ML pipeline predicting the primary genre of Netflix/Disney+ titles (Logistic Regression &amp; Random Forest) — includes EDA, modular training/evaluation/explainability scripts, and a full evaluation report.
...
International Movies"). To keep this a clean multi-class classification
problem, the target is the *first* genre listed ("primary genre"),
reduced to the 10 most frequent genres, with everything else bucketed
into `Other`.
...
No SHAP/LIME — kept intentionally simple.
